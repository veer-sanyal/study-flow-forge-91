-- Drop ALL existing overloads of get_recommended_questions
DROP FUNCTION IF EXISTS public.get_recommended_questions(uuid, integer, integer, integer, integer, text, text, text[], text);
...
-- Recreate the function with proper UUID parameter types
