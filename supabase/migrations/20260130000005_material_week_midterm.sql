...
ALTER TABLE course_materials
  ADD COLUMN IF NOT EXISTS scheduled_week integer,
  ADD COLUMN IF NOT EXISTS corresponds_to_midterm integer;

COMMENT ON COLUMN course_materials.scheduled_week IS 'Week number in the course when this material is covered';
